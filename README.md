...
Ознакомиться с рабочей версией можно вот тут: https://miner-bi.vercel.app/ <br>
SQL код всех запросов в удобном формате тут: [/SQL/sql_overview.md](https://github.com/lwoitr/MinerBI/blob/main/SQL/sql_overview.md)
