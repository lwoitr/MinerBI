...
Ознакомится с рабочей версией можно вот тут: https://miner-bi.vercel.app/
...
Эти таблицы сязаны с таблицей miner_information и явяляются основными данными на которых работает эта системы.
