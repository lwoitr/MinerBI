...
const Cardrow = () => {
  return (
    <div className="flex px-6  items-center bg-[#6D6A75] h-full overflow-hidden justify-between shadow-[#6D6A75] shadow-md w-full py-6">
      <div className="shadow-xl shadow-[#100e12] overflow-hidden z-1 ">
